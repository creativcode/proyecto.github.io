public class Obreros
{
    ...
    public void setIdentificacion(String identificion){
    ...
    Obreros(String identificacion, String nombre, String rango, double suledoUno, double sueldoDos, double sueldoTres){
